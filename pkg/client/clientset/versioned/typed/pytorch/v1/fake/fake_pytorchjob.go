...
func (c *FakePyTorchJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *pytorchv1.PyTorchJob, err error) {
	obj, err := c.Fake.
...
func (c *FakePyTorchJobs) List(ctx context.Context, opts v1.ListOptions) (result *pytorchv1.PyTorchJobList, err error) {
	obj, err := c.Fake.
...
func (c *FakePyTorchJobs) Create(ctx context.Context, pyTorchJob *pytorchv1.PyTorchJob, opts v1.CreateOptions) (result *pytorchv1.PyTorchJob, err error) {
	obj, err := c.Fake.
...
func (c *FakePyTorchJobs) Update(ctx context.Context, pyTorchJob *pytorchv1.PyTorchJob, opts v1.UpdateOptions) (result *pytorchv1.PyTorchJob, err error) {
	obj, err := c.Fake.
...
func (c *FakePyTorchJobs) UpdateStatus(ctx context.Context, pyTorchJob *pytorchv1.PyTorchJob, opts v1.UpdateOptions) (*pytorchv1.PyTorchJob, error) {
	obj, err := c.Fake.
...
func (c *FakePyTorchJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *pytorchv1.PyTorchJob, err error) {
	obj, err := c.Fake.
